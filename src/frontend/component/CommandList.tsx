...
const CommandList = ({
  ...
  return (
    <div className="absolute mx-4 bottom-full left-0 w-44 max-h-60 bg-[var(--vscode-dropdown-background)] border border-[var(--vscode-dropdown-border)] rounded-md shadow-lg z-10">
      <div className="p-1">
        <div className="flex  justify-between text-sm text-[var(--vscode-descriptionForeground)] mb-2">
